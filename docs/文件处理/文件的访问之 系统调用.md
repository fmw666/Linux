...
+ **系统调用** **[open](#-open-系统调用)** / **[close](#-close-系统调用)**

+ **系统调用** **[write](#-write-系统调用)** / **[read](#-read-系统调用)**

+ **系统调用** **[fcntl](#-fcntl-系统调用)**

+ **系统调用** **[lseek](#-lseek-系统调用)**

+ **系统调用** **[\*stat](#-stat-系统调用)**

+ **系统调用** **[mmap](#-mmap-系统调用)** / **[munmap](#-munmap-系统调用)**
